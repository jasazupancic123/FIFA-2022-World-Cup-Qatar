...
router.put('/homeTeamGoals/:id', MatchController.addHomeTeamGoal)
router.put('/awayTeamGoals/:id', MatchController.addAwayTeamGoal)
router.put('/homeTeamLineup/:id', MatchController.addHomeTeamLineup)
router.put('/awayTeamLineup/:id', MatchController.addAwayTeamLineup)
